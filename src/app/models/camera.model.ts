...
export const CAMERA_BRANDS: readonly CameraBrand[] = [
  ...
  { name: 'Tiandy', logo: '/brands/tiandy.webp', aliases: ['tiandy'] },

  { name: 'ABB', logo: '/brands/abb.webp', aliases: ['abb'] },
  { name: 'APSYS', logo: '/brands/apsys.webp', aliases: ['apsys', 'apsys networks'] },
  { name: 'Aqara', logo: '/brands/aqara.webp', aliases: ['aqara'] },
  { name: 'Aruba', logo: '/brands/aruba.webp', aliases: ['aruba', 'aruba networks', 'hpe aruba'] },
  { name: 'ATNT', logo: '/brands/atnt.webp', aliases: ['atnt'] },
  { name: 'Axis', logo: '/brands/axis.webp', aliases: ['axis', 'axis communications'] },
  { name: 'Bolein', logo: '/brands/bolein.webp', aliases: ['bolein'] },
  { name: 'Bosch', logo: '/brands/bosch.webp', aliases: ['bosch'] },
  { name: 'Bose', logo: '/brands/bose.webp', aliases: ['bose'] },
  { name: 'Cisco', logo: '/brands/cisco.webp', aliases: ['cisco'] },
  { name: 'Dell', logo: '/brands/dell.webp', aliases: ['dell'] },
  { name: 'DSPPA', logo: '/brands/dsppa.webp', aliases: ['dsppa'] },
  { name: 'Huawei', logo: '/brands/huawei.webp', aliases: ['huawei'] },
  { name: 'ITC', logo: '/brands/itc.webp', aliases: ['itc'] },
  { name: 'KSTAR', logo: '/brands/kstar.webp', aliases: ['kstar', 'k-star', 'k star'] },
  { name: 'LifeSmart', logo: '/brands/lifesmart.webp', aliases: ['lifesmart', 'life smart'] },
  { name: 'Loxone', logo: '/brands/loxone.webp', aliases: ['loxone'] },
  { name: 'Lutron', logo: '/brands/lutron.webp', aliases: ['lutron'] },
  { name: 'NETCON', logo: '/brands/netcon.webp', aliases: ['netcon', 'net con'] },
  { name: 'Norden', logo: '/brands/norden.webp', aliases: ['norden'] },
  // "Orivibo" is how the artwork arrived and how it is often typed; both resolve.
  { name: 'ORVIBO', logo: '/brands/orvibo.webp', aliases: ['orvibo', 'orivibo'] },
  { name: 'Panduit', logo: '/brands/panduit.webp', aliases: ['panduit'] },
  { name: 'Pelco', logo: '/brands/pelco.webp', aliases: ['pelco'] },
  { name: 'Reolink', logo: '/brands/reolink.webp', aliases: ['reolink'] },
  { name: 'Seagate', logo: '/brands/seagate.webp', aliases: ['seagate', 'seagete'] },
  { name: 'Sonos', logo: '/brands/sonos.webp', aliases: ['sonos'] },
  { name: 'Televes', logo: '/brands/televes.webp', aliases: ['televes', 'televés'] },
  { name: 'Toshiba', logo: '/brands/toshiba.webp', aliases: ['toshiba'] },
  { name: 'TP-Link', logo: '/brands/tp-link.webp', aliases: ['tp-link', 'tplink', 'tp link'] },
  // The mark reads "WD / Western Digital", and a store room writes either.
  { name: 'Western Digital', logo: '/brands/wd.webp', aliases: ['wd', 'western digital'] },
  { name: 'Wi-Tek', logo: '/brands/wi-tek.webp', aliases: ['wi-tek', 'witek', 'wi tek'] },
  { name: 'Wisenet', logo: '/brands/wisenet.webp', aliases: ['wisenet', 'hanwha', 'hanwha vision'] },
  // Filed as GIMI in the artwork, printed XGIMI on the product.
  { name: 'XGIMI', logo: '/brands/xgimi.webp', aliases: ['xgimi', 'gimi'] },
];
